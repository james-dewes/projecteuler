def main():
    grid = [['08', '02', '22', '97', '38', '15', '00', '40', '00', '75', '04', '05', '07', '78',
             '52', '12', '50', '77', '91', '08'],
            ...
            ['01', '70', '54', '71', '83', '51', '54', '69', '16', '92', '33', '48', '61', '43',
             '52', '01', '89', '19', '67', '48']]
    max_value = max([up_down(grid), side_side(grid), down_right(grid),down_left(grid)])
    print 'max:' + str(max_value)


def up_down(a_grid):
    '''
    In a 20 by 20 grid check all multiples of 4 vertically adjacent figures
    @param grid: a 20 x 20 list of lists
    @return: int
    '''
    max_value = 0
    for row in range(0, len(a_grid)-3):
        for col in range(0, len(a_grid[row])):
            total = 1
            for number in range(0, 4):
                total = total * int(a_grid[row+number][col])
...
def side_side(a_grid):
    '''
    In a 20 by 20 grid check all multiples of 4 horizontally adjacent figures
    @param grid: a 20 x 20 list of lists
    @return: int
    '''
    max_value = 0
    for row in a_grid:
        for col in range(0, len(row)-3):
            total = 1
            for number in range(0, 4):
                total = total * int(row[col+number])
...
def down_right(a_grid):
    '''
    In a 20 by 20 grid check all multiples of 4 diagonally adjacent figures
    ...
    max_value = 0
    for row in range(0, len(a_grid)-3):
        for col in range(0, len(a_grid[row])-4):
            total = 1
            for number in range(0, 4):
                total = total * int(a_grid[row+number][col+number])
...
def down_left(a_grid):
    ...
    for row in range(0, len(a_grid)-3):
        for col in range(0, len(a_grid[row])):
            total = 1
            for number in range(0, 4):
                total = total * int(a_grid[row+number][col+4-number])
